...
columns_to_drop = ['product_description','order_zipcode']
data = data.drop(columns=columns_to_drop)
print("Dropped 'product_description' and 'order_zipcode' columns due to high missing values")
...
print(f"Cleaned data saved with shape: {len(data)} rows and {len(data.columns)} columns") #180519 rows and 59 columns
